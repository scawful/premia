...
public enum PremiaAPIClientGeneratedAPI {}

open class PremiaAPIClientGeneratedAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.premia.local",
    ...
    public static let shared = PremiaAPIClientGeneratedAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: PremiaAPIClientGeneratedAPIConfiguration
