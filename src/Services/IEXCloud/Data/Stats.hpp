...
class Stats {
 private:
  ...
  double week52high;   // Highest fully adjusted price observed during trading
                       // hours over the past 52 calendar weeks
  double week52low;    // Lowest fully adjusted price observed during trading
                       // hours over the past 52 calendar weeks
  double week52highSplitAdjustOnly;  // Highest split adjusted price observed
                                     // during trading hours over the past 52
                                     // calendar weeks
  double week52lowSplitAdjustOnly;   // Lowest split adjusted price observed
                                     // during trading hours over the past 52
                                     // calendar weeks
  double week52change;               // Based on 52 calendar weeks
  double sharesOutstanding;  // Number of shares outstanding as the difference
  ...
  double dividendYield;  // The ratio of trailing twelve month dividend compared
                         // to the previous day close price. The dividend yield
  ...
  double beta;  //	number 	Beta is a measure used in fundamental analysis
                //to determine the volatility of an asset or portfolio in
                //relation to the overall market. Levered beta calculated with 1
 ...
 public:
  ...
  double getWeek52highSplitAdjustOnly() const {
    return week52highSplitAdjustOnly;
  }
  void setWeek52highSplitAdjustOnly(double week52highSplitAdjustOnly_) {
    week52highSplitAdjustOnly = week52highSplitAdjustOnly_;
  }

  double getWeek52lowSplitAdjustOnly() const {
    return week52lowSplitAdjustOnly;
  }
  void setWeek52lowSplitAdjustOnly(double week52lowSplitAdjustOnly_) {
    week52lowSplitAdjustOnly = week52lowSplitAdjustOnly_;
  }
  ...
  void setSharesOutstanding(double sharesOutstanding_) {
  ...
  void setTtmDividendRate(double ttmDividendRate_) {
    ttmDividendRate = ttmDividendRate_;
  }
  ...
  void setDividendYield(double dividendYield_) {
    dividendYield = dividendYield_;
  }
  ...
  void setDay200MovingAvg(double day200MovingAvg_) {
    day200MovingAvg = day200MovingAvg_;
  }

  double getDay50MovingAvg() const { return day50MovingAvg; }
  void setDay50MovingAvg(double day50MovingAvg_) {
    day50MovingAvg = day50MovingAvg_;
  }

  double getMaxChangePercent() const { return maxChangePercent; }
  void setMaxChangePercent(double maxChangePercent_) {
    maxChangePercent = maxChangePercent_;
  }

  double getYear5ChangePercent() const { return year5ChangePercent; }
  void setYear5ChangePercent(double year5ChangePercent_) {
    year5ChangePercent = year5ChangePercent_;
  }

  double getYear2ChangePercent() const { return year2ChangePercent; }
  void setYear2ChangePercent(double year2ChangePercent_) {
    year2ChangePercent = year2ChangePercent_;
  }

  double getYear1ChangePercent() const { return year1ChangePercent; }
  void setYear1ChangePercent(double year1ChangePercent_) {
    year1ChangePercent = year1ChangePercent_;
  }

  double getYtdChangePercent() const { return ytdChangePercent; }
  void setYtdChangePercent(double ytdChangePercent_) {
    ytdChangePercent = ytdChangePercent_;
  }

  double getMonth6ChangePercent() const { return month6ChangePercent; }
  void setMonth6ChangePercent(double month6ChangePercent_) {
    month6ChangePercent = month6ChangePercent_;
  }

  double getMonth3ChangePercent() const { return month3ChangePercent; }
  void setMonth3ChangePercent(double month3ChangePercent_) {
    month3ChangePercent = month3ChangePercent_;
  }

  double getMonth1ChangePercent() const { return month1ChangePercent; }
  void setMonth1ChangePercent(double month1ChangePercent_) {
    month1ChangePercent = month1ChangePercent_;
  }

  double getDay30ChangePercent() const { return day30ChangePercent; }
  void setDay30ChangePercent(double day30ChangePercent_) {
    day30ChangePercent = day30ChangePercent_;
  }

  double getDay5ChangePercent() const { return day5ChangePercent; }
  void setDay5ChangePercent(double day5ChangePercent_) {
    day5ChangePercent = day5ChangePercent_;
  }
};
}  // namespace iex
}  // namespace Premia
