...
void MenuView::StyleColorsPremia(ImGuiStyle* dst)
{
...
void MenuView::drawStyleEditor()
{
    ...
    if (ImGui::Button("Premia Theme")) { StyleColorsPremia(); };
...
void MenuView::drawResearchMenu()
{
