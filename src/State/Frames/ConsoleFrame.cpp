...
void ConsoleFrame::addLog(const char* fmt, ...)
{
    // FIXME-OPT
    char buf[1024];
    va_list args;
...
void ConsoleFrame::executeCommand(const char* command_line)
{
    addLog("# %s\n", command_line);
...
ConsoleFrame::ConsoleFrame() : Frame()
{
    clearLog();
